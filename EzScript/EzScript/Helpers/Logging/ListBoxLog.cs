...
{
    const string DEFAULT_MESSAGE_FORMAT = "{0} [{5}] : {8}";
    const int DEFAULT_MAX_LINES_IN_LISTBOX = 2000;

    bool _disposed;
    ListBox _listBox;
    string _messageFormat;
    int _maxEntriesInListBox;
    bool _canAdd;
    bool _paused;
    ...
    delegate void AddALogEntryDelegate(object item);

    void AddALogEntry(object item)
    {
    ...
    string FormatALogEventMessage(LogEvent logEvent, string messageFormat)
    {
